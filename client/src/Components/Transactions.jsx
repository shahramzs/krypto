...
const TransactionsCard = ({addressTo, addressFrom, message, keyword, amount, url, timestamp}) => {
    const gifUrl = useFetch({keyword})

    return (
        <div className='bg-[#666666] m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl'>
    ...
    return (
        <div className='flex w-full justify-center items-center 2xl:px-20'>
            <div className='flex flex-col md:p-12 py-12 px-4'>
                {currentAccount ? (
                    <h3 className='rext-white text-3xl text-center my-2'>Latest Transactions</h3>
                ) : (
                    <h3 className='rext-white text-3xl text-center my-2'>Connect your account to see the latest transactions</h3>
                )}
